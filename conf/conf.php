...
$InitPHP_conf['db']['default'][0]['password']               = '19921001'; //数据库密码
$InitPHP_conf['db']['default'][0]['database']               = 'webauth'; //数据库
 ...
 */
$InitPHP_conf['redis']['redis1']['server']     = '127.0.0.1';
$InitPHP_conf['redis']['redis1']['port']       = '6379';