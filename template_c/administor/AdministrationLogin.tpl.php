<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2013-06-09 09:49:15, compiled from D:\xampp\htdocs\test/template/administor/AdministrationLogin.htm */ ?>
...
<form action="index.php?c=administor&a=deallogin" method="post">
<table width="840" border="0" align="center" cellpadding="30">
<tr>
    <td colspan="2" align="center" bgcolor="#FFFFEE">&nbsp;</td>
  </tr>
  <tr>
    <td width="50%" align="right" bgcolor="#FFFFEE">Administration ID:</td>
    <td align="left" bgcolor="#FFFFEE"><input type="text" name="name"/></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#FFFFEE">Password:</td>
    <td align="left" bgcolor="#FFFFEE"><input type="password" name="psw"/></td>
  </tr>
  <tr>
    <td colspan="2" align="center" bgcolor="#FFFFEE"><input type="submit" value="Submit"/></td>
  </tr>
 </table>
</form>
</body>
