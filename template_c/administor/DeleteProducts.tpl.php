<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2013-06-09 10:14:23, compiled from D:\xampp\htdocs\test/template/administor/DeleteProducts.htm */ ?>
...
<form action="index.php?c=administor&a=dealdelete" name=form method="post">
<table width="840" border="0" align="center" cellpadding="15">
  <tr align="center" valign="middle">
 	<td colspan="2" bgcolor="#ffffee">
    	<br />
    	Please input the ID of the product deleted.<br/>
    </td>
  </tr>
  <tr>
 	<td width="394" align="right" valign="middle" bgcolor="#ffffee">
   	ID:</td><td width="400" bgcolor="#ffffee"><input type="text" name="id" size="20" />
    </td>
  </tr>
  <tr>
