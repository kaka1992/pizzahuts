<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2013-06-09 10:21:18, compiled from D:\xampp\htdocs\test/template/order/orderConfirm.htm */ ?>
...
<table width="840" border="0" align="center" cellspacing="0" bgcolor="FFFFEE">
  <tr bgcolor="#FFFFCC" class="tishi">
    <td height="112" colspan="4" align="center" valign="middle"> <span class="tishi" id="result_box" lang="en" xml:lang="en">Order Confirmation successful
     waiting delivery</span></td>
  </tr>
  <tr>
    <td colspan="4" bgcolor="#EAE1F0"><p><span class="confirm">buyer confirm:<?php echo $username; ?></span><br />
        <span class="info">address:<?php echo $address; ?><br /> 
        telephone:<?php echo $telephone; ?>
<br /> 
message:<?php echo $message; ?><br />
        </span><span class="info"> branch:<?php echo $branch; ?> </span><br />
    </p></td>
  </tr>
  <tr>
    <td colspan="4" bgcolor="#F7F7D0"><span class="confirm">order confirm</span><br />      
    <span class="info">list No</span></td>
  </tr>
  <tr  >
